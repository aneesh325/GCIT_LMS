...
<tr> 
 <td><%=b.getCardNo()%></td>	
  <td><%=b.getName()%></td>
   <td><%=b.getAddress()%></td>
   <td><%=b.getPhone()%></td>
   <td><button type="button" class="btn btn-warning"onClick="javascript:location.href='Checkout.jsp?cardNo=<%=b.getCardNo()%>'">Checkout</button></td>
 
 
   <td><button type="button" class="btn btn-danger"onClick="javascript:location.href='Return.jsp?cardNo=<%=b.getCardNo()%>'">Return</button></td>
